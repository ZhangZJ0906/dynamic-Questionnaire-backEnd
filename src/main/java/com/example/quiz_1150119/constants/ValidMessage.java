...
public class ValidMessage {
	...
	public static final String DESCRITION_ERROR = " decrition error !!";
	...
	public static final String QUIZ_IS_NULL = " quiz is null    !!";
	public static final String QUESTION_VO_IS_EMPTY = " question vo  is empty    !!";
}
